...
function SecurityMisconfigration() {
            ...
            <div className='flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12'>
                <div className='w-full lg:w-2/3'>
                    ...
                    <div className='p-4 mt-12'>
                        ...
                        <div className='mt-10'>
                            <h2 className='text-3xl'>OWASP Top 10 - A10:2021 - Server-Side Request Forgery (SSRF)</h2>
                            <p className='text-gray-400 mt-4'>
                        ...
                        <div className='mt-10'>
                            ...
                            <p class Name='text-gray-400 mt-4'>
...
export default SecurityMisconfigration;