...
function CryptographicFailures() {
            ...
            <div className='flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12'>
                <div className='w-full lg:w-2/3'>
                    ...
                    <div className='p-4 mt-12'>
                        ...
                        <div className='mt-10'>
                            <h2 className='text-3xl'>OWASP Top 10 - A02:2021 - Cryptographic Failures</h2>
                            <p className='text-gray-400 mt-4'>
                                Cryptography is the theory of what keeps our communications secure between senders and intended readers. Our latest OWASP 2021 course on A02-Cryptographic Failures explores what happens when an adversary intercepts our confidential messages using strategies such as a man-in-the-middle attack. Learn how to exploit and mitigate critical vulnerabilities so that you block out all the eavesdroppers!
                            </p>
                        </div>
                        <div className='mt-10'>
                        ...
                        <div className='mt-10'>
                            ...
                            <ul className='text-gray-400 mt-2'>
                                ...
                                <li>Guided demos in platforms such as OWASP Mutillidae.</li>
                                <li>Written scenarios that highlight the relevance of the OWASP Top 10 web application vulnerabilities in real-world ransomware attacks and data breaches, including the 2021 Colonial Pipeline Hack and the 2017 Equifax Breach. You will gain insights of the history and significance of these incidents.</li>
                                <li>Custom hands-on labs created by our vendor partner, Cydefe, which allow you to identify, exploit, and mitigate these critical vulnerabilities, as well as offer remediation advice to clients.</li>
                            </ul>
                        </div>
                    </div>
                </div>
