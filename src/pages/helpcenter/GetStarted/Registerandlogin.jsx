  ...
  return (
    <div className="bg-white min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-grow p-6">
        ...
        <p className="mt-4 text-gray-700 text-lg mr-48 ">
          In order to log in to your account, you will need to provide your
          email address, followed by the password you created upon registration.
          A username is not required to register for an account, and cannot be
          used to log into your Cybrary account.
        </p>
        <p className="mt-10 text-gray-700 text-lg mr-48 ">
          If you are having trouble logging in, follow these steps:
        </p>

        <ul className="list-disc pl-6 mt-4 text-gray-700 text-lg  mr-40 ml-8 space-y-2">
          <li>
            Confirm your email has been verified (for newly registered users).
            Check your inbox for a verification email. If you have no received
            one, please contact support@cybrary.it for further assistance
          </li>
          <li>
            Confirm your email address matches the one associated with your
            Cybrary account. You can look up the email associated with your
            account via "Forgot Email". If you cannot confirm the correct email,
            please contact support@cybrary.it.
          </li>
          <li>
            Confirm your password is correct. If you are unsure of your password
            or would like to reset it, use "Forgot Password" to get a link to
            reset your password sent to the email address associated with your
            Cybrary account. If you do not receive the password reset email, or
            are unsuccessful in logging on to Cybrary, please contact
            support@cybrary.it.
          </li>
        </ul>
        <p className="mt-10 text-gray-700 text-lg mr-48 ">
