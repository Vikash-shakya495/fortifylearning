                ...
                <div className='w-full lg:w-2/3'>
                    ...
                    <div className="bg-black text-white p-4 mt-20">
                        ...
                        >
                            ...
                            >
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>The F5 BIG-IP (CVE-2022-1388)</span> <span>10M</span></li>
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>CVE Overview</span> <span>10M</span></li>
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>Exploitation</span> <span>0M</span></li>
