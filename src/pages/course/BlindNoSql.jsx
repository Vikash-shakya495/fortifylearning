        ...
        <div className="w-full lg:w-2/3">
          <div className="flex flex-wrap gap-20 mt-16">
            <div className="flex flex-col items-center gap-2">
              <h1 className="text-2xl lg:text-3xl">1H 10M</h1>
          ...
          <div className="bg-black text-white p-4 mt-20">
            ...
            >
              <div className="flex justify-between items-center mt-4 mb-4">
                <p className="text-lg">Exploit and Mitigate the Blind NoSQL Injection Vulnerability</p>
                {/* Arrow */}
                <span
          ...
          <div className="p-4 mt-12">
            ...
            <div className="mt-6">
              <h2 className="text-3xl">
                What makes this course different from other courses on similar
                topics?
              </h2>
              <p className="text-gray-400 mt-4">
              ...
              <ul className="text-gray-400 mt-2">
                <li className="flex gap-4">
                  <TbPointFilled className="text-white mt-1" /> Define the
                  attack, describe its root cause, and communicate its
                  significance to key organizational stakeholders.
                </li>
                <li className="flex gap-4">
                  <TbPointFilled className="text-white mt-1" /> Exploit this
                  vulnerability using publicly available exploit code.
                </li>
                <li className="flex gap-4">
                  <TbPointFilled className="text-white mt-1" /> Execute various
                  mitigation tactics to reduce risk.
                </li>
              </ul>
              <p className="text-gray-400 mt-4">
                This course is taught by Raymond Evans, a member of the CyDefe
                team. CyDefe develops and operates capture-the-flag (CTF) style
                environments, and this course focuses on presenting learners
                with virtual labs where you can dirctly apply what you've
                learned.
              </p>
            </div>
            <div className="mt-10">
              ...
              <p className="text-gray-400 mt-4">
                This on-demand course gives you the hands-on experience needed
                to protect and defend your organization against the critical
                vulnerability. In one hour, offensive and defensive security
                professionals can become more prepared to defend their
                organization against this flaw that could allow an adversary to
                cause significant damage on a victim system. In this course, you
                will see just how quick and easy it is to exploit this
                vulnerability from the perspective of an adversary. You will be
                able to not only exploit and mitigate this critical
                vulnerability, but also describe its significance to
