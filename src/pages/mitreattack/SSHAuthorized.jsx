            ...
            <div className='flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12'>
                    ...
                    <div className="bg-black text-white p-4 mt-20">
                        ...
                        >
                            <div className='flex justify-between items-center mt-4 mb-4'>
                                <p className="text-lg">Account Manipulation: SSH Authorized Keys</p>
                                <span
                            ...
                            >
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>What are SSH Authorized Keys?</span> <span>15m</span></li>
                                <li className="pl-4 mb-4 flex text-gray-400 justify-between"><span>Detection, Validation, and Mitigation</span> <span>30m</span></li>
                ...
                <div className='w-full lg:w-1/3'>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='text-center text-gray-400 mt-8'>Complete this entire course to earn a SSH Authorized Keys Certificate of Completion</p>
                    </div>
                </div>
            </div>
        </div>
