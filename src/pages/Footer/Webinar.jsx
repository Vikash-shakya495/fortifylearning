        ...
        <div className='mt-28'>
            ...
            <div className="mt-24 w-full text-white py-12 px-4 md:px-32 flex flex-col  ">
                ...
                <div className='flex items-center mb-12 gap-6'>
                    ...
                    <p className=" text-3xl text-gray-400" id='webinar#ctig'>
                        CTIG Research
                    </p>
                </div>
            ...
            <div className="mt-24 w-full text-white py-12 px-4 md:px-32 flex flex-col" id='team-management'>
                {/* Heading Section */}
                <div className='flex items-center mb-12 gap-6'>
                    <h2 className="h-6 w-6 bg-gradient-to-r from-red-500 to-fuchsia-500 rounded-[50%]"></h2>
                    <p className="text-3xl text-gray-400" id='webinar#team-management'>Team Management</p>
                </div>
            ...
            <div className="mt-24 w-full bg-gradient-to-b from-gray-95  0 to-black text-white py-12 px-4 md:px-32 flex flex-col  ">
                ...
                <div className='flex items-center mb-12 gap-6'>
                    ...
                    <p className=" text-3xl text-gray-400" id='webinar#certifications'>
                        Certifications
                    </p>
                </div>
            ...
            <div className="mt-24 w-full bg-gradient-to-b from-gray-95  0 to-black text-white py-12 px-4 md:px-32 flex flex-col " id='webinar#news-events'>
                {/* Heading Section */}
                <div className='flex items-center mb-12 gap-6'>
                    <h2 className="h-6 w-6 bg-gradient-to-r from-red-500 to-fuchsia-500 rounded-[50%]">
                    </h2>
