                ...
                <div className='w-full lg:w-2/3'>
                    <div className='flex flex-wrap gap-20 mt-16'>
                        <div className='flex flex-col items-center gap-2'>
                            <h1 className='text-2xl lg:text-3xl'>1H 30M</h1>
                    ...
                    <div className="bg-black text-white p-4 mt-20">
                        ...
                        >
                            <div className='flex justify-between items-center mt-4 mb-4'>
                                <p className="text-lg">Investigate
                                The Art of Hidden Data</p>
                                {/* Arrow */}
                                <span
                    ...
                    <div className='p-4 mt-12'>
                        ...
                        <div className='mt-10'>
                            ...
                            <p className='text-gray-400 mt-4'>In this challenge, you will take on a Steganography challenge identifying embedded data within an audio file. Malicious attackers use Steganography for attacks such as macro-enabled Word documents, to conceal covert communication, and more. The goal is to show how attackers can effortlessly embed data within files to hide their activity.
                        ...
                        <div className='mt-10'>
                            ...
                            What resources are available to help solve this challenge?:</h2>
                            <p className='text-gray-400 mt-4'>
                ...
                <div className='w-full lg:w-1/3'>
                    ...
                    <div className='p-8 flex items-center gap-4 border bg-slate-900 rounded-xl mt-12'>
                        ...
                        <div className='w-2/3 text-center'>
                            ...
                            <p className='text-xl mt-4'>Marc Balingit</p>
                        </div>
                    </div>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='text-center text-gray-400 mt-8'>Complete this entire course to earn a Challenge: Don't Believe What You Hear Certificate of Completion</p>
                    </div>
                </div>
            </div>
        </div>
