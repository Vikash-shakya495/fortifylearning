        ...
        <div className='mt-44 md:w-full'>
            <div className="flex flex-col md:flex-row items-center justify-center w-full text-white py-8 px-8 sm:px-12 lg:px-36 gap-8 lg:gap-8">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left flex flex-col">
                    ...
                    Challenge: Saving a Fellow<br />Monster
                    </h2>

                    <p>
                    In this challenge, you will take on a Steganography challenge<br />
                    identifying embedded data within an image. Malicious attackers<br />
                    use Steganography for attacks such as macro-enabled Word<br />
                    documents, to conceal covert communication and more. The goal<br />
                    is to show how attackers can effortlessly embed data within files<br />
                    to hide their activity.<br />
                    </p>
            ...
            <div className='flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12'>
                <div className='w-full lg:w-2/3'>
                    <div className='flex flex-wrap gap-20 mt-16'>
                        <div className='flex flex-col items-center gap-2'>
                            <h1 className='text-2xl lg:text-3xl'>1H 45M</h1>
                    ...
                    <div className='p-4 mt-12'>
                        ...
                        <div className='mt-10'>
                            <h2 className='text-3xl'>Blue Team Analyst POV: Steganography </h2>
                            <p className='text-gray-400 mt-4'>
                            In this challenge, you will take on the Steganography challenge of identifying embedded data<br/>
                            within an image. Malicious attackers use steganography for different attacks, such as macro-<br/>
                            enabled Word documents, audio files, and pictures. This challenge aims to mimic a<br/>
                            steganography attack by showcasing how effortlessly attackers can embed data within files.<br/> 
                            External tools are not needed for this challenge.
                            <br/>
                            <br/>
                            <p>![CySeeker Peculiar](//images.ctfassets.net/kvf8rpi09wgk/<br/>
                            qbEzmd4efRzpA1lBEW8vZ/9fb4bc97f855861107cfa48daf666920/CySeeker_Peculiar.png)</p>
                            </p>
                        </div>
                        <div className='mt-6'>
                            <h2 className='text-3xl'>Who is this for: </h2>
                            <p className='text-gray-400 mt-4'>
                            Early career to mid practitioners. This challenge may be difficult for individuals new to<br/> 
                            cybersecurity, but the difficulty rating on this challenge is relatively low. We encourage using<br/> 
                            any internet resources and community/colleague assistance in completing the challenge.
                            </p>
                        </div>
                        <div className='mt-10'>
                            <h2 className='text-3xl'>Are write-ups permitted? </h2>
                            <p className='text-gray-400 mt-4'>
                            Yes, write-ups are permitted; please do not post answers directly. All write-ups should<br/> 
                            include a link to Cybrary and the Cybrary Course.
                            </p>
                            <div className='mt-10'></div>
                            <h2 className='text-3xl'>What resources are available to help solve this challenge?:  </h2>
                            <p className='text-gray-400 mt-4'>
                ...
                <div className='w-full lg:w-1/3'>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='text-center text-gray-400 mt-8'>Complete this entire course to earn a Challenge: Saving a Fellow Monster Certificate of Completion</p>
                    </div>
                </div>
            </div>
