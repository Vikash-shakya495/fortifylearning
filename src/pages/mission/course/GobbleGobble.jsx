...
function GobbleGobble() {
  ...
  return (
    <div className="mt-44 md:w-full">
      <div className="flex flex-col md:flex-row items-center justify-center w-full text-white py-8 px-8 sm:px-12 lg:px-36 gap-8 lg:gap-8">
        {/* Left Section */}
        <div className="w-full md:w-1/2 text-center md:text-left flex flex-col">
          <span className="w-20 py-1 bg-gradient-to-r from-red-500 via-pink-500 to-fuchsia-500 rounded-2xl text-white text-center font-semibold mx-auto md:mx-0">
            FREE
          </span>
          <h2 className="text-2xl sm:text-3xl md:mb-6 lg:mb-12 md:text-4xl lg:text-5xl mt-4">
            Challenge: Gobble Gobble
            <br />
            Conceal & Deceive
          </h2>

          <p>
            In this challenge, you will take on a Steganography challenge
            <br />
            identifying embedded data within an image. Malicious attackers
            <br />
            use Steganography for attacks such as macro-enabled Word
            <br />
            documents, to conceal covert communication and more. The goal
            <br />
            is to show how attackers can effortlessly embed data within files
            <br />
          ...
          <div className="flex flex-row items-center mt-4 gap-6 justify-center md:justify-start">
            <button
              onClick={() => dispatch(togglePopup())}
              className=" py-3 bg-gradient-to-r from-red-500 via-pink-500 to-fuchsia-500 rounded-xl text-white font-semibold hover:shadow-[0px_0px_10px_purple,0px_0px_10px_#FF4D6D] duration-500 px-6 "
            >
              Create Free Account
            </button>
            <NavLink to="/business">
              <button className="px-4 md:px-6 py-3 md:py-4 rounded-xl bg-black flex items-center gap-4 text-sm sm:text-base border border-gray-600 border-[1px]">
        ...
        <div className="bg-white text-black p-6 sm:p-8 rounded-3xl shadow-lg w-full md:w-1/2 h-auto max-w-lg mx-auto">
          ...
          <div className="flex  justify-center items-center border border-gray-600 px-3 py-2 mb-6 rounded-3xl">
            <input
              type="email"
      ...
      <div className="flex flex-col-reverse lg:flex-row mx-auto mt-32 w-11/12 lg:w-4/5 p-4 gap-12">
            ...
            >
              ...
              >
                <li className="pl-4 mb-4 flex text-gray-400 justify-between">
                  <span>Introduction to CouchDB</span> <span>10M</span>
                </li>
                <li className="pl-4 mb-4 flex text-gray-400 justify-between">
                  <span>Understanding RCE Vulnerabilities</span> <span>0M</span>
                </li>
                <li className="pl-4 mb-4 flex text-gray-400 justify-between">
                  <span>Exploitation Techniques</span> <span>0M</span>
                </li>
                <li className="pl-4 mb-4 flex text-gray-400 justify-between">
                  <span>Mitigation Strategies</span> <span>10M</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="p-4 mt-12">
            ...
            <div className="mt-10">
              ...
              <p className="text-gray-400 mt-4">
                In this challenge, you will take on the Steganography challenge
                of identifying embedded data
                <br />
                within an image. Malicious attackers use steganography for
                different attacks, such as macro-
                <br />
                enabled Word documents, audio files, and pictures. This
                challenge aims to mimic a<br />
                steganography attack by showcasing how effortlessly attackers
                can embed data within files.
                <br />
                External tools are not needed for this challenge.
                <br />
                <br />
                <p>
                  ![CySeeker Peculiar](//images.ctfassets.net/kvf8rpi09wgk/
                  <br />
                  qbEzmd4efRzpA1lBEW8vZ/9fb4bc97f855861107cfa48daf666920/CySeeker_Peculiar.png)
                </p>
              </p>
            </div>
            <div className="mt-6">
              ...
              <p className="text-gray-400 mt-4">
                ...
                difficult for individuals new to
                <br />
                cybersecurity, but the difficulty rating on this challenge is
                relatively low. We encourage using
                <br />
                any internet resources and community/colleague assistance in
            ...
            <div className="mt-10">
              ...
              <p className="text-gray-400 mt-4">
                ...
                directly. All write-ups should
                <br />
                include a link to Cybrary and the Cybrary Course.
              </p>
        ...
        <div className="w-full lg:w-1/3">
          ...
          <div className="p-8 flex items-center gap-4 border bg-slate-900 rounded-xl mt-12">
            ...
            <button >
              <h2 className="text-lg lg:text-xl bg-gradient-to-r from-red-600 via-pink-500 to-fuchsia-700 rounded-xl px-4">
                Instructor
              </h2>
              </button>
