    ...
    <div className="mt-44 md:w-full">
      <div className="flex flex-col md:flex-row items-center justify-center md:w-full  text-white py-8 px-12 md:px-44 gap-12">
        <div className="w-full md:w-1/2 md:mb-0 text-center md:text-left flex flex-col">
          ...
          <p className="text-gray-400">
            Advanced Persistent Threats (APTs) conduct state-sponsored
            cyberattacks that can radically disrupt global business operations.
            Launch this campaign to start detecting sophisticated techniques
            leveraged by APT41, known as "Double Dragon" because they cause
            double trouble with both espionage and financially-motivated
            attacks!
          </p>
      ...
      <div className="mt-20 text-white py-12 px-4 md:px-32 xl:px-72 flex flex-col items-center">
        ...
        <p className="text-center w-2/3 mb-12 text-gray-400">
          ...
          courses. Click on a course below to learn more.
        </p>
          ...
          {salesforceCourses.map((course, index) => (
            <div className="w-full ">
              <div className="flex flex-col md:flex-row items-center bg-gray-900 p-8 w-full gap-12">
                <div
                  key={index}
                  className="bg-gray-900 md:w-1/3 rounded-sm  transition duration-500 hover:rounded-2xl shadow-lg hover:shadow-xl border border-gray-600 "
                >
                  <img
                    src={course.img}
                    alt=""
                    className="h-[200px] w-full object-cover rounded-lg transition duration-700 rounded-sm hover:rounded-tl-2xl hover:rounded-tr-2xl"
                  />
                  <div className="p-6">
                    <h3 className="text-2xl font-semibold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-pink-600 to-fuchsia-600">
                      {course.title}
                    </h3>
